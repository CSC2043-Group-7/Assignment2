...
$insertquery = "UPDATE galleryimages SET imgdescript='$descript' WHERE id='$editid'";	
          
    }else{     
 
         move_uploaded_file($filetemp,"../gallery/$filename");   

$insertquery = "UPDATE galleryimages SET imgname='$filename', imgdescript='$descript' WHERE id='$editid'";
...
<html>
    ...
    <body>
		...
		echo "<img src=../gallery/ echo $filename; ' width='50%'/>";
		      echo "<p>Description update:<strong>$descript<strong></p>";
